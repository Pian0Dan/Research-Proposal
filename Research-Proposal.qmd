...
After visualising the outputs of the algorithm across these different scenarios, we will then hope to establish a dashboard that will help guide quota constraint choices and strengthen representativeness. This will be designed to allow users to input their population and survey sample data, alongside their Panelot-generated lottery output and a specific seed, then visualise the distribution of traits and intersections in the selected panel against the population, to make it easier to assess representative performance across panel selections.
